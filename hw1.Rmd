---
title: "SOC577 Homework 1: Data Structures and Programming in R"
...
Please review the AI assistance policy on the syllabus before proceeding. As discussed in class, it is a violation of academic integrity to try to solve the homework problems using ChatGPT or related tools by inputting information from the homework. You are also forbidden from using Copilot in RStudio. You are, however, permitted to use ChatGPT or other tools to help you learn about different functions and coding skills. There will be a space at the end of the assignment where you must document the use of any tools.
